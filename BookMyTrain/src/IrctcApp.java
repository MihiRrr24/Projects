...
public class IrctcApp {
    ...
    // coz we cant load everything by user some need pre loaded
    ...
    public void register()
    {
        ...
        scanner.nextLine();        // flushify when we use string after one string again then they merge so to remove that we use nextLine
